...
const Navber = () => {
  ...
  return (
   ...
   <nav className={`fixed top-0 left-0 w-full py-6 z-50 transition duration-500 hidden md:block
      ...
      <Container>
           ...
           <div className='flex justify-between px-6'>
            ...
            <Link to="/">
              <Image src={Panto} className={(location.pathname === '/product' || (location.pathname.startsWith('/product/') && scrolled) || (location.pathname === '/' && scrolled)) ? 'logo-black' : ''}/>
            </Link>
   ...
   ${getBackgroundClass()} ${getTextColor()}`}>
              <Link to="/">
                <Image src={Panto} className={`h-8 ${(location.pathname === '/product' || (location.pathname.startsWith('/product/') && scrolled) || (location.pathname === '/' && scrolled)) ? 'logo-black' : ''}`} />
              </Link>
           <div>
